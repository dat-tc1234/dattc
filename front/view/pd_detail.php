        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered mt-3">
                    <tbody>
                        <tr><th>Công suất</th><td><?php echo htmlspecialchars($product['cong_suat']); ?></td></tr>
                        <tr><th>Số cánh</th><td><?php echo htmlspecialchars($product['so_canh']); ?></td></tr>
                        <tr><th>Công nghệ</th><td><?php echo htmlspecialchars($product['cong_nghe']); ?></td></tr>
                        <tr><th>Tốc độ</th><td><?php echo htmlspecialchars($product['toc_do']); ?></td></tr>
                        <tr><th>Chất liệu</th><td><?php echo htmlspecialchars($product['chat_lieu']); ?></td></tr>
                        <tr><th>Chức năng</th><td><?php echo htmlspecialchars($product['chuc_nang']); ?></td></tr>
                    </tbody>
                </table>
